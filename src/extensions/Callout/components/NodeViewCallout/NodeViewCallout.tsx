...
const CALLOUT_TYPES = [
  { value: 'note', label: 'Note', icon: Info, color: '#1f6feb', background: '#1f6feb1f' },
  { value: 'tip', label: 'Tip', icon: Lightbulb, color: '#238636', background: '#2386361f' },
  { value: 'important', label: 'Important', icon: AlertCircle, color: '#ab7df8', background: '#ab7df81f' },
  { value: 'warning', label: 'Warning', icon: TriangleAlert, color: '#d29922', background: '#d299221f' },
  { value: 'caution', label: 'Caution', icon: OctagonAlert, color: '#f85149', background: '#f851491f' },
] as const;
...
export function NodeViewCallout({ node }: any) {
  ...
  return (
    <NodeViewWrapper>
      ...
      >
        <div className={clsx('richtext-mb-2 richtext-flex richtext-items-center richtext-gap-2', {
        ...
        {body && <p className='richtext-pl-[28px]'>
          {body}
        </p>}
      </div>
    </NodeViewWrapper>
